...
def svm_loss_naive(W, X, y, reg):
    ...
    for i in range(num_train):
        ...
        for j in range(num_classes):
            ...
            if margin > 0:
                loss += margin
                dW[:,j] += X[i]  #inncorrect class gradient increased as penalty for score[thisClass] 
                                 #being too high on this training example, this increase in dW is soon
                                 #to be SUBTRACTED from Wgrad
